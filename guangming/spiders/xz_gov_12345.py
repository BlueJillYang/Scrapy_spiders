...
class Xz_gov_12345(scrapy.Spider):
    name = "xz_gov_12345"  # 12345徐州市政府服务热线
    start_urls = [
        'http://12345.xz.gov.cn/xzbmweb/ywxxtemplate/ggfw_slgs.aspx news',
        'http://12345.xz.gov.cn/xzbmweb/ywxxtemplate/slgs.aspx news',
    ]
    Debug = True
    doredis = True
    source = u"徐州市12345政府服务热线"
    ...
    def __init__(self,start_url=None):
        super(Xz_gov_12345, self).__init__()
    ...
    def parse_link(self, response):
        data_list = response.xpath('//*[contains(@id, "_grdList")]//tr/td/a[contains(@onclick, "window.open")]')
        if len(data_list) > 0:
    ...
    def parse_item(self, response):
        ...
        item['medianame'] = u'徐州市12345政府服务热线'
