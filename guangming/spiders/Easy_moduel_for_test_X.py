...
class jswxbhjy(scrapy.Spider):
    name = "jswxbhjy"
    start_urls = [
           "http://www.bhjy.net/News/include/list_common.jsp?schoolId=1&typeId=news34&findInfo= news"
    ]
    Debug = True
    doredis = True
    source = u"无锡滨湖教育新闻信息网"
